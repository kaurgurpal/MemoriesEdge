...
namespace MemoriesEdgeAdmin.Web
{
    ...
    public class wcfAdmin : IwcfAdmin
    {
      ...
      public int AddNewUser(AddEditOperator objNewUser)
       ...
       //public IList<AddEditOperator> GetCountries(int UserId)
       //    {
       //         var a = (from con in objAlpha.OperatorAddresses.AsEnumerable()
       //                  where con.Operator_ID==UserId
       //                     select new AddEditOperator
       //                      {
       //                       Country = con.Country
       //                       });
       //         List<AddEditOperator> obj = new List<AddEditOperator>();
       //         obj.Add(new AddEditOperator() { CountryId = -1, Country = "[Please Select]"  });
       //         var Result = obj.Union(a.ToList());
       //         return Result.ToList();
       //    }


       //    public IList<AddEditOperator> GetStates(int UserId)
       //    {
       //        var a = (from con in objAlpha.OperatorAddresses.AsEnumerable()
       //                  where con.Operator_ID==UserId
       //                     select new AddEditOperator
       ...
       //                     });
       //        List<AddEditOperator> obj = new List<AddEditOperator>();
       //        obj.Add(new AddEditOperator() { StateId = -1, State = "[Please Select]" });
       //        var Result = obj.Union(a.ToList());
       //        return Result.ToList();
               
       //    }

       //    public IList<AddEditOperator> GetCities(int UserId)
       //    {
       //        var a = (from con in objAlpha.OperatorAddresses.AsEnumerable()
       //                 where con.Operator_ID == UserId
       //                 select new AddEditOperator
       ...
       //                 });
       //        List<AddEditOperator> obj = new List<AddEditOperator>();
       //        obj.Add(new AddEditOperator() { CityId = -1, City = "[Please Select]" });
       //        var Result = obj.Union(a.ToList());
       //        return Result.ToList();
       //    }
           ...
           public IList<ManageFeedBack> GetAllAnswers(int aid)
           {
               var a = from b in objAlpha.FeedbackAnswerMasters
                       ...
                       select new ManageFeedBack
                       {
                           FeedbackQuestion = s.Feedback_Question,
