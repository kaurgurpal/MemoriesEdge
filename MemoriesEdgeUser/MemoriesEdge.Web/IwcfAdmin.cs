...
namespace MemoriesEdge.Web
{
    ...
    public interface IwcfAdmin
    {
        ...
        [OperationContract]
        int UpdateQuestion(ManageFeedBack entity);
        [OperationContract]
        ManageFeedBack ShowQuestionStatus(ManageFeedBack entity);
        [OperationContract]
        ManageFeedBack DispalyQues(ManageFeedBack entity);
        [OperationContract]
        ManageFeedBack ShowAnswerStatus(ManageFeedBack entity);
        [OperationContract]
        int SaveAnswers(ManageFeedBack entity);
        [OperationContract]
        int UpdateAnswers(ManageFeedBack entity);

        //ViewFeedback
        [OperationContract]
        IList<ViewFeedBack> GetUsersFeedback();
        //[OperationContract]
        //ViewFeedBack ViewUserQuestion(ViewFeedBack entity);
        //[OperationContract]
        //int SaveFeedback(ViewFeedBack obj);
    }
}
