...
{
    public class clsNewUserValidation:INotifyPropertyChanged,IDataErrorInfo
    {
        ...
        {
            get { return strSecurityQuestion; }
            set
            {
                strSecurityQuestion = value;
                ChangeValue("SecurityQuestion");
            }
        }
        ...
        {
            get { return strSecurityAnswer; }
            set
            {
                strSecurityAnswer = value;
                ChangeValue("SecurityAnswer");
            }
        }
        ...
        public string this[string columnName]
        {
            get
            {
                ...
                if (columnName == "SecurityAnswer")
                {
                    if (SecurityAnswer == null)
                    {
                        strMsg = "Enter Required Answer";
                    }
                }
